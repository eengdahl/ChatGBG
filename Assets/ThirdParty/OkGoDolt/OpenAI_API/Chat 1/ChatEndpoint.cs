...
namespace OpenAI_API.Chat
{
	...
	public class ChatEndpoint : EndpointBase, IChatEndpoint
	{
        ...
        /// Constructor of the api endpoint.  Rather than instantiating this yourself, access it through an instance of OpenAIAPI
        ...
        /// Conversation which encapulates a back and forth chat betwen a user and an assistant.
        ...
        /// <returns>Asynchronously returns the completion result. Look in itshatResult.Choices property for the results.
        ...
        /// <returns ChatResult with the API response.
        ...
        /// Ask the API to complete the request using the specified parameters. This is non-streaming, so it will wait until the API returns the full result.
		//Any non-specified parameters will fall back to default values specified in DefaultChatRequestArgs
		///userMessages The user message or messages to use in the generation.  All strings are assumed to be of Role ChatMessageRole.User
